    ...
    <div class="p-4 mt-16 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 min-h-56 border-dashed h-auto mb-20 rounded-lg ">
            ...
            <div class="sm:rounded-lg bg-cyan-50 p-4 border border-cyan-500">
                ...
                <form id="questionForm" action="/teacher/question/{{ $exam->id }}" method="post"
                    ...
                    <button type="button" onclick="addQuestion()" class="text-cyan-500 mt-2">Tambah Soal</button>
...
@push('scripts')
    <script>
        ...
        function addQuestion() {
            ...
            textarea.id = `editor${questionCount}`;
            textarea.className =
            ...
            textarea.name = `content[${questionCount}]`;
            ...
            deleteButton.className = 'text-red-500';
            deleteButton.addEventListener('click', () => removeQuestion(questionCount));
            ...
            optionsDiv.id = `optionsContainer${questionCount}`;

            const addOptionButton = document.createElement('button');
            addOptionButton.type = 'button';
            addOptionButton.innerText = 'Tambah Option';
            addOptionButton.className = 'text-cyan-500 mt-2';
            addOptionButton.addEventListener('click', () => addOption(questionCount));
            ...
            ClassicEditor
                .create(document.querySelector(`#editor${questionCount}`), {
                    ckfinder: {
                        uploadUrl: '{{ route('ckeditor.upload') . '?_token=' . csrf_token() }}'
                    },
                    mediaEmbed: {
